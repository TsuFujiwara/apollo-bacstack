...
import { GET_TARGETSANDOBJECTS } from "./graphql/queries";
import { ADD_TARGET, DELETE_TARGET, UPDATE_TARGET } from "./graphql/mutations";
...
const BacnetTargetsTable = ({ classes }) => {
  let targetName;
  let targetIp;
...
export default withStyles(styles)(BacnetTargetsTable);
